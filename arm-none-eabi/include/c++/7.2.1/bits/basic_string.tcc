...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    _GLIBCXX_NOEXCEPT
    {
      ...
      if (__n <= __size)
	{
	  __pos = std::gccmin(size_type(__size - __n), __pos);
	  const _CharT* __data = _M_data();
	  do
	    {
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    compare(size_type __pos, size_type __n, const basic_string& __str) const
    {
      ...
      const size_type __len = std::gccmin(__n, __osize);
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
	    ...
	    size_type __pos2, size_type __n2) const
    {
      ...
      const size_type __len = std::gccmin(__n1, __n2);
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    compare(const _CharT* __s) const _GLIBCXX_NOEXCEPT
    {
      ...
      const size_type __len = std::gccmin(__size, __osize);
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    compare(size_type __pos, size_type __n1, const _CharT* __s) const
    {
      ...
      __n1 = _M_limit(__pos, __n1);
      const size_type __osize = traits_type::length(__s);
      const size_type __len = std::gccmin(__n1, __osize);
